...
Twirp uses Github releases. To make a new release:
 ...
 4. Tag the commit you just made: `git tag <version number>` and `git push
    origin --tags`
 5. Go to Github https://github.com/aspiration-labs/twirp/releases and
    "Draft a new release".
...
See the [LICENSE](https://github.com/aspiration-labs/twirp/blob/master/LICENSE) file for our project's licensing. We will ask you to confirm the licensing of your contribution.
