...
$ go get -u github.com/aspiration-labs/twirp/protoc-gen-twirp
```
...
Github. See the [releases](https://github.com/aspiration-labs/twirp/releases) page.
...
```sh
$ retool upgrade github.com/aspiration-labs/twirp/protoc-gen-twirp v5.2.0
```
...
```sh
$ cd $GOPATH/src/github.com/aspiration-labs/twirp
$ git checkout v5.2.0
