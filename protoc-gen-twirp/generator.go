...
import (
	...
	"github.com/aspiration-labs/twirp/internal/gen"
	"github.com/aspiration-labs/twirp/internal/gen/stringutils"
	"github.com/aspiration-labs/twirp/internal/gen/typemap"
)
...
func (t *twirp) generateFileHeader(file *descriptor.FileDescriptorProto) {
	...
	if t.filesHandled == 0 {
		...
		t.P("This code was generated with github.com/aspiration-labs/twirp/protoc-gen-twirp ", gen.Version, ".")
		t.P()
...
func (t *twirp) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`import `, t.pkgs["twirp"], ` "github.com/aspiration-labs/twirp"`)
	t.P(`import `, t.pkgs["ctxsetters"], ` "github.com/aspiration-labs/twirp/ctxsetters"`)
	t.P()
