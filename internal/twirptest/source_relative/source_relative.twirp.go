...
This code was generated with github.com/aspiration-labs/twirp/protoc-gen-twirp v5.5.2.
...
import twirp "github.com/aspiration-labs/twirp"
import ctxsetters "github.com/aspiration-labs/twirp/ctxsetters"
...
type Svc interface {
	Method(context.Context, *Msg) (*Msg, error)
}
...
func (c *svcProtobufClient) Method(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest.source_relative")
...
func (c *svcJSONClient) Method(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest.source_relative")
	ctx = ctxsetters.WithServiceName(ctx, "Svc")
	ctx = ctxsetters.WithMethodName(ctx, "Method")
	out := new(Msg)
...
const SvcPathPrefix = "/twirp/twirp.internal.twirptest.source_relative.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.internal.twirptest.source_relative.Svc/Method":
...
func (s *svcServer) serveMethod(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *svcServer) serveMethodJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Method")
	...
	func() {
		...
		respContent, err = s.Svc.Method(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Msg and nil error while calling Method. nil responses are not supported"))
		return
	}
...
func (s *svcServer) serveMethodProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Method")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
